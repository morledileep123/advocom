     ...
     if(isset($_POST['submit'])){
         if($_SESSION['prod_nameErr'] == "" && $_SESSION['prod_qtyErr'] == "" ) {  
            ...
            if ($conn->query($prodsql) == TRUE) {
                 ...
                 header("Location: https://www.advocatemail.com/member/payment_method/payment.php?product_id=" . $_POST['product_id']); 
                 exit();
        	 } else {
            	 $_SESSION['errors'] = "You are allready registered for SEO services";
                 header("Location: https://www.advocatemail.com/member/service/seo/seo.php?product_id=" . $_POST['product_id']);
                 exit();
        	 }
        	 mysqli_close($conn);
