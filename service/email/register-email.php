...
include_once ('../../db.php'); 
 ...
 $prod_pass = isset($_SESSION['prod_pass']) ? $_SESSION['prod_pass'] : '';
 unset($_SESSION['prod_pass']);
 $prod_passErr = isset($_SESSION['prod_passErr']) ? $_SESSION['prod_passErr'] : '';
 unset($_SESSION['prod_passErr']);
 ...
 <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
       ...
       <div class="panel panel-primary">
        <div class="panel-heading">Member Email Register</div>
          <div class="panel-body">
              <form action="email_register_process.php" method="post">
					...
					<div class="form_line"> 
						...
						<input type="password" name="prod_pass" value="<?php echo $prod_pass; ?>" class="form-control" />
						<span style="color:red;"><?php echo $prod_passErr; ?> </span>
					</div>
					<div class="form_line"> 
						<label>Product Name</label>:</label><br>
